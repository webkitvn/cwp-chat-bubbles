...
var CWPChatBubbles = (() => {
  // src/js/chat-bubble.js
  var LAZY_FETCH_TIMEOUT = 4e3;
  var PREFETCH_DELAY = 2500;
  var RETRY_DELAY = 300;
  var frontendI18n = window.cwpChatBubbles && window.cwpChatBubbles.i18n ? window.cwpChatBubbles.i18n : {};
  var t = (key, fallback) => Object.prototype.hasOwnProperty.call(frontendI18n, key) ? frontendI18n[key] : fallback;
  var wait = (ms) => new Promise((resolve) => {
    window.setTimeout(resolve, ms);
  });
  var shouldSkipPrefetch = () => {
  ...
  var renderLazyItems = (chatBubbles, payload) => {
...
//# sourceMappingURL=chat-bubbles.min.js.map
